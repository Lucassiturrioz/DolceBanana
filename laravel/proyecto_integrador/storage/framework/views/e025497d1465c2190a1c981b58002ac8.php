            ...
            <tr>
                ...
                <td>
                    <?php $__currentLoopData = $pedido->item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e($unItem->producto->nombre_producto); ?> (<?php echo e($unItem->cantidad); ?>) - $<?php echo e(number_format($unItem->total, 2)); ?><br>
...
<?php /**PATH C:\Facultad 2024\Back up 2024\Curso PHP\TP\ProyectoFullStack\laravel\proyecto_integrador\resources\views/emails/compra.blade.php ENDPATH**/ ?>